...
- (void)setPhoto:(NSDictionary *)photo {
    ...
    // set the instagramURL
    NSString *urlString = _photo[@"link"];
    self.instagramURL = [[NSURL alloc] initWithString:urlString];
    ...
    // number of likes
    NSNumber *numberOfLikes = _photo[@"likes"][@"count"];
    [self.likesButton setTitle:[numberOfLikes stringValue] forState:UIControlStateNormal];
    
    // number of comments
    NSNumber *numberOfComments = _photo[@"comments"][@"count"];
    [self.commentsButton setTitle:[numberOfComments stringValue] forState:UIControlStateNormal];
}
